...
-- retail clcret correct values, cause isses with addon disable function **update mop SOO** seems to work?
...
-- classic clcret incorrect values but work
-- function clcret:CLCRETDisable()
	-- if addonInit then
		-- addonEnabled = true
		-- self.frame:Show()
